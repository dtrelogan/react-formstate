...
Form state is managed through a simple API. You control every aspect of your form. (It's not a closed form controller served up in decorator pattern where you can only configure the workflow that it drives through the options it makes available.)
